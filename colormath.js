var Color = (function() {
	...
	Color.prototype.steps = function(rgb, steps) {
		...
		steps +=1;
		i = 1/steps;
		for(var percentage = i; percentage<0.99999; percentage += i) {
	...
	Color.prototype.add = function() {
		var sum = [this.r, this.g, this.b, this.a],
		color,
		newSum;
	...
	Color.prototype.subtract = function() {
		var minuend = [this.r, this.g,this.b,this.a],
		difference,
		color;
		for(var i =0; i<arguments.length; i++) {
			color = arguments[i];
	...
	Color.prototype.multiply = function() {
		var product=[this.r, this.g, this.b],
		color,
		newProduct;
